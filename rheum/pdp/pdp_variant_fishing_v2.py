...
for variant in cyvcf2.VCF('/home/users/cjyoon/Projects/rheum/data_processing/01_freebayes/everyone.freebayes.decomposed.norm.vep.centelexcl.vcf.gz'):
    ...
    if variant_type(pdp1[0:2]) == 'het' and variant_type(pdp4[0:2]) != 'homo_alt' and \
    ((variant_type(pdp2[0:2])== 'homo_ref' and variant_type(pdp3[0:2])=='het') or \
    (variant_type(pdp2[0:2])=='het' and variant_type(pdp3[0:2]) == 'homo_ref')) and \
    not re.search(r'(intron_variant|regulatory_region_variant|intergenic_variant|downstream|upstream|UTR|non_coding|TF_binding_site_variant|synonymous)', consequence) and (float(max_af_gnomad) < float(0.01)):
...
candidate_file = '/home/users/cjyoon/Projects/rheum/data_processing/01_freebayes/fishing/PDP_candidates_v2.txt'
with open(candidate_file, 'w') as f:        
    ...
    for variant in cyvcf2.VCF('/home/users/cjyoon/Projects/rheum/data_processing/01_freebayes/everyone.freebayes.decomposed.norm.vep.centelexcl.vcf.gz'):
        ...
        if variant_type(pdp1[0:2]) == 'het' and variant_type(pdp4[0:2]) != 'homo_alt' and \
        ((variant_type(pdp2[0:2])=='homo_ref' and variant_type(pdp3[0:2])=='het') or (variant_type(pdp2[0:2])=='het' and variant_type(pdp3[0:2])=='homo_ref')) \
        and not re.search(r'(intron_variant|regulatory_region_variant|intergenic_variant|downstream|upstream|UTR|non_coding|TF_binding_site_variant|synonymous)', consequence) and (float(max_af_gnomad) < float(0.01)):
...
with open(candidate_file, 'a') as f:        
    for variant in cyvcf2.VCF('/home/users/cjyoon/Projects/rheum/data_processing/01_freebayes/everyone.freebayes.decomposed.norm.vep.centelexcl.vcf.gz'):
        ...
        if variant_type(pdp1[0:2]) == 'het' and variant_type(pdp2[0:2]) == 'homo_ref' and variant_type(pdp3[0:2]) == 'homo_ref' and variant_type(pdp4[0:2]) == 'homo_ref' \
        and max_af_gnomad < 0.01 and not re.search(r'(intron_variant|regulatory_region_variant|intergenic_variant|downstream|upstream|UTR|non_coding|TF_binding_site_variant|synonymous)', consequence) :
...
with open(candidate_file, 'a') as f:        
    for variant in cyvcf2.VCF('/home/users/cjyoon/Projects/rheum/data_processing/01_freebayes/everyone.freebayes.decomposed.norm.vep.centelexcl.vcf.gz'):
        ...
        if variant_type(pdp1[0:2]) == 'homo_alt' and variant_type(pdp2[0:2]) == 'het' and variant_type(pdp3[0:2]) == 'het' and variant_type(pdp4[0:2]) != 'homo_alt' \
        and max_af_gnomad < 0.01 and not re.search(r'(intron_variant|regulatory_region_variant|intergenic_variant|downstream|upstream|UTR|non_coding|TF_binding_site_variant|synonymous)', consequence) :
